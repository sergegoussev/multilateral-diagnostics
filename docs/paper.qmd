...
The following section demonstrates and explains example diagnostics for a specific category in Dominick's Finer foods dataset [@dominicksmanual]. Further examples are available on the project site.[^2] @fig-fsf-ccdi-example shows the application of GEKS-T to the Fabric Softener dataset. A specific period of price change is then chosen for further analysis.
